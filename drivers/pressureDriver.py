...
""" 
Driver for Pfeiffer TPG261 Pressure Gauge.
Code adapted from https://github.com/CINF/PyExpLabSys/blob/master/PyExpLabSys/drivers/pfeiffer.py
"""
    ...
    * RST: RS232 test
    ...
    def __init__(self, port='/dev/ttyS0', baudrate=9600):
        ...
        :param port: The COM port to open. See the documentation for
            ...
            of the possible value. The default value is '/dev/ttyS0'.
    ...
    def _send_command(self, command):
        ...
        if response == self._cr_lf(self.NAK).encode():
            message = 'Serial communication returned negative acknowledge'
            raise IOError(message)
        elif response != self._cr_lf(self.ACK).encode():
...
if __name__ == "__main__":
    pressureUnit = TPG261()
    # print(pressureUnit.program_number())
    print(pressureUnit.pressure_gauge(gauge=1))