...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_35 = QtGui.QLabel(self.page_keithley)
        self.label_35.setObjectName(_fromUtf8("label_35"))
        self.gridLayout_7.addWidget(self.label_35, 5, 0, 1, 1)
        self.label_36 = QtGui.QLabel(self.page_keithley)
        self.label_36.setObjectName(_fromUtf8("label_36"))
        self.gridLayout_7.addWidget(self.label_36, 6, 0, 1, 1)
        self.comboBox_2 = QtGui.QComboBox(self.page_keithley)
        self.comboBox_2.setObjectName(_fromUtf8("comboBox_2"))
        self.comboBox_2.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.comboBox_2, 5, 1, 1, 1)
        self.comboBox_5 = QtGui.QComboBox(self.page_keithley)
        self.comboBox_5.setObjectName(_fromUtf8("comboBox_5"))
        self.comboBox_5.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.comboBox_5, 6, 1, 1, 1)
        ...
        self.horizontalLayout_3.addWidget(self.checkBox_IV)
        self.checkBox = QtGui.QCheckBox(self.page_IVmeas)
        ...
        self.metalStartButton = QtGui.QPushButton(self.tab_4)
        self.metalStartButton.setObjectName(_fromUtf8("metalStartButton"))
        self.gridLayout_21.addWidget(self.metalStartButton, 3, 0, 1, 1)
        self.metalStopButton = QtGui.QPushButton(self.tab_4)
        self.metalStopButton.setObjectName(_fromUtf8("metalStopButton"))
        self.gridLayout_21.addWidget(self.metalStopButton, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_Measurement.setItemText(2, _translate("MainWindow", "Electical Measurements", None))
        ...
        self.label_35.setText(_translate("MainWindow", "Range [CURRENT]", None))
        self.label_36.setText(_translate("MainWindow", "Range [VOLTAGE]", None))
        self.comboBox_2.setItemText(0, _translate("MainWindow", "Auto", None))
        self.comboBox_5.setItemText(0, _translate("MainWindow", "Auto", None))
        ...
        self.checkBox.setAccessibleName(_translate("MainWindow", "takeIVreverse", None))
        self.checkBox.setText(_translate("MainWindow", "Repeat with reverse sweep", None))
        ...
        self.metalStartButton.setAccessibleName(_translate("MainWindow", "metalButton", None))
        self.metalStartButton.setText(_translate("MainWindow", "START METAL EVAP", None))
        self.metalStopButton.setAccessibleName(_translate("MainWindow", "metalStopButton", None))
        self.metalStopButton.setText(_translate("MainWindow", "STOP", None))
